  ...
  return (
    <section>
      <div className="grid grid-cols-1 lg:grid-cols-2 h-[100vh] overflow-y-hidden">
        <div className="text-white grid px-12 pt-16 lg:px-12 lg:pt-0 min-h-[430px] bg-yellow self-center justify-self-start lg:min-h-auto relative z-[150]">
        ...
        <div className="bg-white relative w-full lg:border-l-[1px] lg:border-white z-1 ">
          <div
            className="contain absolute left-0 right-0 w-full -translate-y-[300px] lg:-translate-y-[20%]"
